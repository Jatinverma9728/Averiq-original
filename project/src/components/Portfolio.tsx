  ...
  const projects = [
    {
      ...
      category: 'Web',
      description: 'A full-stack e-commerce platform built with React.js, TypeScript, and Tailwind CSS. I used mongoDB for database and node.js for backend. I also Made Fully Working Admin Panel.',
      image: '/Images/4.png',
      year: '2025',
    },
    {
      ...
      category: 'Web',
      description: 'A service-based e-commerce platform, made with HTML, CSS, and JavaScript.',
      image: '/Images/2.png',
      year: '2024',
    },
    {
      ...
      category: 'Web',
      description: 'A personal portfolio website built with React.js, TypeScript, and Tailwind CSS.',
      image: '/Images/3.png',
      year: '2023',
    },
    {
    ...
    // Additional projects will use the first image as fallback
    {
      id: 5,
